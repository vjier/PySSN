...
class DifferentialEvolutionSolver(object):
    ...
    __best_values = []  # Added for returning the best fitness in each iteration
    ...
    def solve(self):
        ...
        for nit in range(1, self.maxiter + 1):
            ...
            if self.disp:
                ...
                self.__best_values.append(self.population_energies[0])
        ...
        DE_result.update({"best_agent_values": self.__best_values})
        return DE_result
